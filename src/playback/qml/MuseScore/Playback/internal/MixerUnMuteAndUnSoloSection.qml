...
Item {
    ...
    Row {
        ...
        FlatToggleButton {
            ...
            navigation.accessible.name: content.accessibleName + " " + qsTrc("playback", "Unmute All")
        ...
        FlatToggleButton {
            ...
            navigation.accessible.name: content.accessibleName + " " + qsTrc("playback", "Unsolo All")
            navigation.onActiveChanged: {
                if (navigation.active) {
                    root.navigateControlIndexChanged({row: navigation.row, column: navigation.column})
                }
